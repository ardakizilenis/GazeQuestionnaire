...
class TextInputWidget(GazeWidget):
    ...
    def _ensure_mode_cache(self):
        ...
        if self.mode == "groups":
            # group labels
            p.drawText(self.cells["N"].adjusted(16, 16, -16, -16), Qt.AlignCenter | Qt.TextWordWrap, "A B C D E F G")
            p.drawText(self.cells["W"].adjusted(16, 16, -16, -16), Qt.AlignCenter | Qt.TextWordWrap, "H I J K L M N")
            p.drawText(self.cells["E"].adjusted(16, 16, -16, -16), Qt.AlignCenter | Qt.TextWordWrap, "O P Q R S T U")
            p.drawText(self.cells["S"].adjusted(16, 16, -16, -16), Qt.AlignCenter | Qt.TextWordWrap, "V W X Y Z ␣")
            p.drawText(self.cells["SW"].adjusted(16, 16, -16, -16), Qt.AlignCenter | Qt.TextWordWrap, "⌫ DEL")
